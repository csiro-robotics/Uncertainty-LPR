...
_SAVEDIR="${_ROOT}/weights/batch_jobs/batch_jobs_pfe_stun_dropout/stun_minkloc_$1"
...
python $_ROOT/training/train.py  \
    --config $_ROOT/config/eval_datasets/minkloc3d_stun.yaml \
    --uncertainty_method STUN \
